...
import { Award, Ban, Check, GanttChartSquare, KeyRound, Loader2, Luggage, MoreVertical, ShieldCheck } from "lucide-react";
...
const roleIconMap = {
  ...
  "ADMIN": <KeyRound className="h-4 w-4 ml-2 text-emerald-500" />
}
                    ...
                    <DropdownMenuTrigger>
                      ...
                      <DropdownMenuContent side="left">
                          ...
                          <DropdownMenuItem onClick={() => onKick(member.id)}>
                            Kick
                            <Ban className="w-4 h-4 ml-auto text-rose-500" />
                          </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenuTrigger>
                  </DropdownMenu>
